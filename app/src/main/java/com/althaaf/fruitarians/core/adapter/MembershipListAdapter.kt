...
class MembershipListAdapter: PagingDataAdapter<DataItem, MembershipListAdapter.MyViewHolder>(DIFF_CALLBACK) {
    class MyViewHolder(private val binding: ItemFruitstoreBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = ItemFruitstoreBinding.inflate(LayoutInflater.from(parent.context), parent, false)
